...
class _Update_LibrarianState extends State<Update_Librarian> {
  ...
  Future updateLibrarianData(
    ...
    var url = "http://localhost/lbs_php/updateLibrarianData.php";
    final response = await http.post(Uri.parse(url), body: {
      ...
      "username": username,
      "password": password,
      "copylibrarianid" : copylibrarianid,
    });

    var res = jsonDecode(response.body);
    if (res == "true") {
      customLoginToast('Updated Successfully...', context);
    } else {
      customErrorToast('Error Occured While Updating your Details. Please Try again Later...', context);
      clearText();
    }
  }
  ...
  void initState() {
    ...
    copylibrarianid = widget.librarianid;
    print(widget.librarianid);
    super.initState();
  }
