...
class _Checkout_StaffState extends State<Checkout_Staff> {
  ...
  {
    var url = "http://localhost/lbs_php/checkOutBookStaffData.php";
  ...
  // Future searchRegister(String register) async
  // {
  //   var url = "http://localhost/lbs_php/searchStudentRegister.php";
  //   final response = await http.post(Uri.parse(url),
  //   body: {
  //     "registerno" : register,
  //   });
  ...
  Future staffCountUpdate(String register) async {
    var url = "http://localhost/lbs_php/staffCountUpdate.php";
    final response = await http.post(Uri.parse(url),
        body: {
          "registerno" : register,
        });
