...
class _Update_StudentState extends State<Update_Student> {
  ...
  Future checkUsername(String user) async {
    var url = "http://localhost/lbs_php/validateStudent.php";
  ...
  Future updateStudentData(String firstname1, String lastname1, String email1,
      String mobile1, String aadharno1, String gender1, String department1, String year1, String dob1, String registerno1, String username1,
      String password1, String bookcount1)
  async {
    var url = "http://localhost/lbs_php/updateStudentData.php";
    final response = await http.post(Uri.parse(url),
        body: {
                        ...
                        onPressed: () {
                          if (formKey.currentState!.validate()) {
                            if(value1 == "true" || value1.isNotEmpty || username.text == widget.username)
                              {
                                updateStudentData(firstname.text.toUpperCase(), lastname.text.toUpperCase(), email.text.toUpperCase(),
                                    mobile.text.toUpperCase(), aadharno.text.toUpperCase(), gender.text.toUpperCase(),
                                    department.text.toUpperCase(), year.text.toUpperCase(), dob.text.toUpperCase(), registerno.text.toUpperCase(), username.text,
                                    password.text, bookcount.text);
                              }
                            else
                              {
